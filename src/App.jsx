...
function DesktopLayout({ isScrolled, currentUser, userRole, logout, openAuthModal }) {
  return (
        ...
        <div style={{maxWidth: '1280px', margin: '0 auto', padding: '0 2rem'}}>
          <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '80px'}}>
            ...
            <div style={{display: 'flex', gap: '2rem', alignItems: 'center'}}>
              <a href="#features" style={{color: '#d1d5db', textDecoration: 'none', fontWeight: '600', transition: 'color 0.2s'}}>Features</a>
              <a href="#how-it-works" style={{color: '#d1d5db', textDecoration: 'none', fontWeight: '600', transition: 'color 0.2s'}}>How It Works</a>
              {currentUser ? (
                <div style={{display: 'flex', alignItems: 'center', gap: '1rem'}}>
                  <span style={{color: '#d1d5db', fontSize: '0.9rem'}}>{currentUser.email}</span>
                  {userRole === 'admin' && (
                    <span style={{
                      padding: '0.25rem 0.75rem',
                      background: 'rgba(196,18,98,0.2)',
      ...
      <section style={{
        ...
        <div style={{maxWidth: '1280px', margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 10}}>
          ...
          <div style={{display: 'flex', gap: '1.5rem', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '4rem'}}>
            ...
            onMouseEnter={(e) => {
              e.target.style.background = 'rgba(68,97,171,0.1)'
              e.target.style.borderColor = '#1ab1ce'
            }}
            onMouseLeave={(e) => {
              e.target.style.background = 'transparent'
              e.target.style.borderColor = '#4461ab'
            }}
            >
              Report Fraud
            </button>
          ...
          <div style={{maxWidth: '800px', margin: '0 auto'}}>
            <div style={{
              ...
              border: '3px solid rgba(68,97,171,0.5)',
              borderRadius: '1.5rem',
              padding: '0.75rem',
              backdropFilter: 'blur(20px)',
              ...
              <input
                type="tel"
                placeholder="Enter MoMo number to check..."
                style={{
                  flex: 1,
        ...
        <div style={{maxWidth: '1280px', margin: '0 auto'}}>
          <div style={{textAlign: 'center', marginBottom: '5rem'}}>
            ...
            <p style={{
              ...
              Everything you need to protect yourself from Mobile Money fraud
            </p>
          </div>
          ...
          <div style={{
            ...
            {[
              {icon: '🔍', title: 'Check Number', desc: 'Search any MoMo number to see if it\'s been reported. Instant verification at your fingertips.', color: '#1ab1ce'},
              {icon: '⚠️', title: 'Report Fraud', desc: 'Submit fraud cases with details and evidence. Help protect others from falling victim.', color: '#c41262'},
              {icon: '📊', title: 'Fraud Dashboard', desc: 'View top reported numbers, fraud trends, and real-time alerts. Stay informed about threats.', color: '#4461ab'},
              {icon: '🔔', title: 'Alerts', desc: 'Get notified if a number you\'ve interacted with is flagged. Real-time protection when you need it.', color: '#1ab1ce'},
              {icon: '📚', title: 'Education', desc: 'Anti-fraud tips and safety resources. Learn how to protect yourself and others.', color: '#4461ab'},
              {icon: '👥', title: 'Multi-Role Access', desc: 'Guest, User, and Admin roles. Access features based on your needs and permissions.', color: '#c41262'}
            ].map((feature, idx) => (
              <div key={idx} style={{
                background: 'rgba(22,25,44,0.8)',
                border: '3px solid rgba(68,97,171,0.3)',
                borderRadius: '1.5rem',
                padding: '2.5rem',
                transition: 'all 0.3s',
                cursor: 'pointer',
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{display: 'flex', gap: '1rem'}}>
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = 'rgba(26,177,206,0.3)'
            ...
            <div>
              ...
              <ul style={{
                ...
                {['Check Number', 'Report Fraud', 'Fraud Dashboard', 'Alerts', 'Education'].map((item) => (
                  <li key={item}>
            ...
            <div>
              ...
              <ul style={{
                ...
                {['Help Center', 'Safety Tips', 'Report Issue', 'FAQ', 'Community'].map((item) => (
                  <li key={item}>
                    <a href="#" style={{
                      color: '#9ca3af',
                      textDecoration: 'none',
